  ...
  return (
    <div className="container">
      ...
      <Flex position="absolute" zIndex={1000} flexDirection="column" alignItems="center">
        <Navbar zIndex={1}/>
        <Text zIndex={0} fontWeight="bold" position="absolute" pt="220px" fontSize={45} color="#6da9d6">rekindle</Text>
        <Text zIndex={0} position="absolute" pt="315px" fontSize={20} color="#6da9d6">Fortifying Human Connection</Text>
